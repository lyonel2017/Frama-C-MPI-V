 ...
 *
 * Version: $Id: parallel_jacobi-annotated.c 4644 2015-06-09 14:55:33Z edrdo $
...
int main( int argc, char** argv){
    ...
    MPI_Scatter(A_initial, n*n_by_p, MPI_FLOAT, A_local, n*n_by_p , MPI_FLOAT, 0, MPI_COMM_WORLD); 
