...
/*@ axiomatic MPI_aux_driver{
  ...
  @ logic logic_protocol protocol_foo4(integer i);
}*/
...
int main(int argc, char** argv) {
  ...
  //   @ loop assigns u[0], u[local_n+1], protocol, iter;
  ...
  /*@ requires get_type(protocol) == protocol_6;
    @ requires isSkip(getNext(getNext(get_type(protocol))));
    @ requires getFirst(get_type(protocol)) == protocol_4;
    @ requires getNext(get_type(protocol)) == protocol_5;
